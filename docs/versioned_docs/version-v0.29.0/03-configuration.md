...
| DISABLE_CSP_HEADERS                    | No                                    | false           | Disables Content Security Policy (CSP) headers for archived assets. **Warning:** Disabling CSP headers allows JavaScript execution in full page archives, which may pose security risks. Only enable this if you understand the security implications and trust the content you're archiving.                           |
