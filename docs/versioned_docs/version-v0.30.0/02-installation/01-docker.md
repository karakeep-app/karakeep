...
Note that if you want to upgrade/migrate `Meilisearch` versions, refer to the [troubleshooting](../../administration/troubleshooting/#upgrading-meilisearch---migrating-the-meilisearch-db-version) page.
