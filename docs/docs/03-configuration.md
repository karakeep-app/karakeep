...
| CRAWLER_GIT_DOWNLOAD                     | No       | false     | Whether to download git repos from the page or not                                                                                                                                                                                                                                                                                                                            |
| CRAWLER_GIT_TIMEOUT                      | No       | 60        | How long to each job downloading a repo should last                                                                                                                                                                                                                                                                                                                           |
| CRAWLER_GIT_REPO_MIRROR                  | No       | false     | Wheter or not to use the `--mirror` flag when cloning                                                                                                                                                                                                                                                                                                                         |
| CRAWLER_GIT_CLONE_DEPTH                  | No       | -1        | How many commits deep to clone the repo, only active when not mirroring                                                                                                                                                                                                                                                                                                       |
| CRAWLER_GIT_CLONE_ALL_BRANCHES           | No       | false     | Wheter or not to run `git fetch --all` to get all remote branches in repo, only active when not mirroring                                                                                                                                                                                                                                                                     |
