...
| WEB_HOST                               | No                                    | 0.0.0.0         | The address on which the web server will listen. You shouldn't change it unless you know what are you doing. By default listens on all interfaces.                                                                                                                     |
