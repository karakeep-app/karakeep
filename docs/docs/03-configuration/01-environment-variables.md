...
| CRAWLER_STORE_CONTENT_IMAGES             | No       | false     | Whether to download and cache images found in extracted reader content for offline access. When enabled, images in the reader view are stored locally and the HTML is rewritten to reference local assets.                                                                                                                                                                      |
| CRAWLER_CONTENT_IMAGE_MAX_COUNT          | No       | 50        | Maximum number of images to cache per bookmark when content image caching is enabled.                                                                                                                                                                                                                                                                                          |
| CRAWLER_CONTENT_IMAGE_MAX_SIZE_MB        | No       | 5         | Maximum size in MB per individual image when caching content images.                                                                                                                                                                                                                                                                                                           |
| CONTENT_IMAGE_NUM_WORKERS                | No       | 1         | Number of content image worker threads.                                                                                                                                                                                                                                                                                                                                        |
| CONTENT_IMAGE_JOB_TIMEOUT_SEC            | No       | 120       | Timeout in seconds for content image processing job.                                                                                                                                                                                                                                                                                                                           |
