...
| YOUTUBE_API_KEY                          | No       | Not set   | YouTube Data API v3 key for fetching enhanced metadata from YouTube videos. If not set, the crawler will fall back to extracting metadata from the HTML. Get your API key from the [Google Cloud Console](https://console.cloud.google.com/apis/credentials).                                                                                                                 |
