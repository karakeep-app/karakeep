...
| `list:<id>`                      | Match bookmarks by the list's immutable id (cuid2). Use this in Smart Lists so they don't break when a list is renamed.                     | `list:kidcwffcnie6rky83n9xof8x`              |
