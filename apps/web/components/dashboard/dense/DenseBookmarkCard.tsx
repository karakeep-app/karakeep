...
export function DenseBookmarkCard({
  ...
  return (
    <div className="border-k-border bg-k-surface-1 group relative flex flex-col gap-2 rounded-xl border p-[16px_17px]">
      <Link
      ...
      <div className="pointer-events-none relative z-10 flex items-center justify-between">
        ...
        <div className="pointer-events-auto flex items-center gap-2">
          <button
            ...
            className="text-k-fg-dim hover:text-k-fg-muted relative z-20 flex size-[15px] items-center justify-center"
          >
      ...
      <div className="pointer-events-none relative z-10 flex items-center gap-2">
        <span
          className={cn(
            "line-clamp-2 text-[16px] font-semibold tracking-[-0.015em]",
      ...
      {isPendingSummary ? (
        <div className="pointer-events-none relative z-10 flex flex-col gap-[6px] py-[2px]">
          <div className="bg-k-skeleton h-2 rounded-[3px]" />
          <div className="bg-k-skeleton h-2 w-[72%] rounded-[3px]" />
        </div>
      ) : bookmark.summary ? (
        <p className="text-k-fg-muted pointer-events-none relative z-10 line-clamp-3 text-[12.5px] leading-[1.6]">
          {bookmark.summary}
        </p>
      ) : null}
